# script to write lidar data to geotiff files
...
for(i in 6:length(plot_list)){
  ...
  file_folder <- "D:/D03/OSBS/2014/OSBS_L3/OSBS_Lidar/CHM/"
  
  # folder to save images
  # leave backslash on folder name
  save_folder <-"../data/NEON_plot_spatial_data/digitizing_images/chm/"
  
  img_file_name <- paste(plot_name,"chm",sep="_")
